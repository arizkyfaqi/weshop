<?php
	...
	$query = mysqli_query($koneksi, "SELECT pesanan.nama_penerima, pesanan.nomor_telepon, pesanan.alamat, pesanan.tanggal_pemesanan, user.nama, kota.kota, kota.tarif FROM pesanan JOIN user ON pesanan.user_id=user.user_id JOIN kota ON pesanan.kota_id=kota.kota_id WHERE pesanan.pesanan_id='$pesanan_id' ");
...
<div id="frame-faktur">
	...
	<div id="frame-keterangan">
		<p>
			...
			Nomor Rekning : 450797904 (A/N TOKOHARFA).<br/>
